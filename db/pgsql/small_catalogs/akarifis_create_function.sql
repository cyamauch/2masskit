...
CREATE FUNCTION fAkariFisGetNearestObjIDEq(FLOAT8,FLOAT8,FLOAT8)
  RETURNS INT4
...
CREATE FUNCTION fAkariFisGetNearbyObjEq(FLOAT8,FLOAT8,FLOAT8)
...
CREATE FUNCTION fAkariFisGetNearbyObjCel(TEXT, FLOAT8, FLOAT8, FLOAT8)
  RETURNS SETOF tObjCelAndDistance
  AS 'SELECT o.*
      FROM (
       SELECT objid,
...
CREATE FUNCTION fAkariFisGetNearbyObjFromBoxCelSimple(TEXT,FLOAT8,FLOAT8,FLOAT8,FLOAT8)
...
CREATE FUNCTION fAkariFisGetNearbyObjFromBoxCel(coo TEXT, lon_c FLOAT8, lat_c FLOAT8,
  ...
  RETURNS SETOF tObjCel AS $$
    DECLARE
      ...
      ndiv INT4;
    BEGIN
      tbl := 'AkariFis';  -- constant: table name
...
-- private
CREATE FUNCTION _fAkariFisGetObjFromRectEq(tInternalRectArgs)
  RETURNS SETOF tObjCel
  AS 'SELECT objid,ra,dec FROM AkariFis
...
CREATE FUNCTION fAkariFisGetObjFromRectEq(FLOAT8,FLOAT8,FLOAT8,FLOAT8)
  RETURNS SETOF tObjCel
  AS 'SELECT _fAkariFisGetObjFromRectEq(_fMakeInternalRectArgs($1,$2,$3,$4))'
  LANGUAGE 'sql';
