...
CREATE FUNCTION fIrasGetNearestObjIDEq(FLOAT8,FLOAT8,FLOAT8)
  RETURNS INT4
...
CREATE FUNCTION fIrasGetNearbyObjEq(FLOAT8,FLOAT8,FLOAT8)
...
CREATE FUNCTION fIrasGetNearbyObjCel(TEXT, FLOAT8, FLOAT8, FLOAT8)
  RETURNS SETOF tObjCelAndDistance
  AS 'SELECT o.*
      FROM (
       SELECT objid,
...
CREATE FUNCTION fIrasGetNearbyObjFromBoxCelSimple(TEXT,FLOAT8,FLOAT8,FLOAT8,FLOAT8)
...
CREATE FUNCTION fIrasGetNearbyObjFromBoxCel(coo TEXT, lon_c FLOAT8, lat_c FLOAT8,
...
-- private
CREATE FUNCTION _fIrasGetObjFromRectEq(tInternalRectArgs)
  RETURNS SETOF tObjCel
  AS 'SELECT objid,ra,dec FROM Iras
...
CREATE FUNCTION fIrasGetObjFromRectEq(FLOAT8,FLOAT8,FLOAT8,FLOAT8)
  RETURNS SETOF tObjCel
  AS 'SELECT _fIrasGetObjFromRectEq(_fMakeInternalRectArgs($1,$2,$3,$4))'
  LANGUAGE 'sql';
